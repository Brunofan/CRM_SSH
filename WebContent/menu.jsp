		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					...
					<TD align="center" width=180 background="${pageContext.request.contextPath}/images/new_006.jpg" height=35><B>人力资源 －功能菜单</B></TD>
							...
							<TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');">
										<SPAN class=span id=table_2Span>＋</SPAN> 联系人管理
									</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman/addUILinkMan.action" target=main>－ 新增联系人</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman/findAllLinkMan.action" target=main>－联系人列表</A>
													</TD>
												</TR>
